...
from .backbones.resnet_ibn_a import resnet50_ibn_a, resnet101_ibn_a, resnet152_ibn_a    # Thử train với 152_ibn_a
from .backbones.se_resnet_ibn_a import se_resnet101_ibn_a, se_resnet152_ibn_a           # Thử train với 152
from .backbones.resnest import resnest50, resnest101, resnest200, resnest269            # Thử train với 200 và 269
from .backbones.resnext_ibn import resnext101_ibn_a, resnext152_ibn_a                   # Thử train với 152
...
class build_transformer(nn.Module):
    def __init__(self, num_classes, camera_num, view_num, cfg, factory):
        ...
        if pretrain_choice == 'self':
            ...
            print("Loading finetine model........from {}".format(model_path))
...
class Backbone(nn.Module):
    def __init__(self, num_classes, cfg):
        ...
        ############################ Các loại model resnet ############################
        if model_name == 'resnet50':
            self.in_planes = 2048   # chiều của feature vector
            self.base = ResNet(last_stride=last_stride, block=Bottleneck,
...
def make_model(cfg, num_classes, camera_num=0, view_num=0):
    if cfg.MODEL.NAME == 'transformer':
        model = build_transformer(num_classes, camera_num, view_num, cfg, __factory_hh)
        print('===========building transformer===========')
    else:
        print('===========ResNet===========')
        model = Backbone(num_classes, cfg)
    return model